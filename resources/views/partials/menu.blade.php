<aside class="main-sidebar sidebar-dark-primary elevation-4" style="min-height: 917px;">
    <!-- Brand Logo -->
    <a href="{{ Route::current()->getName() != 'home' ? route('home') : '' }}" class="brand-link" align="center" >
        <!-- <span class="brand-text font-weight-light" >{{ trans('panel.site_title') }}</span> -->
        <button type="button" class="btn btn-outline-light">{{ trans('panel.site_title') }}</button>
    </a>
